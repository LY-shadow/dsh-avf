...
[DeepSeek Harness (DSH)](https://github.com/deepseek-ai/deepseek-harness) 是 DeepSeek 官方推出的 AI 开发工具集。本教程帮助你在 **Android AVF 虚拟机**（Android 的 Linux 终端环境）中完整部署 DSH，涵盖：
